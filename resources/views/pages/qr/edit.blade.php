    ...
    <div class="px-2">
        <form class="row" action="#" method="post" id="form-edit" name="form-edit">
            ...
            <div class="col-12 col-lg-6">
                <div class="mb-3 row">
                    <label class="col-lg-4 col-form-label">QR Number: <span class="text-danger">*</span></label>
                    <div class="col-lg-8">
                        <input type="text" class="form-control" placeholder="ASTA/XXX/XXX" name="qr_no"
                            value="{{ $data->qr_no }}" required>
                    </div>
                </div>
                <div class="mb-3 row">
