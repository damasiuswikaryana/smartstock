                                        ...
                                        <div class="row mb-2 align-items-center">
                                            ...
                                            <div class="col-12 col-lg-2">
                                                <select class="form-select entitas-select"
                                                    ...
                                                    data-gudang-id="{{ $data->werehouse_id }}">
                                            ...
                                            <div class="col-4 col-lg-2 text-center">
                                                <input type="text" class="form-control stock-display"
                                                    value="Stock: {{ $variant->getStockByLokasiandEntitas($data->werehouse_id, $entitasParam) }}"
                                                    disabled>
                                            </div>
                                            <div class="col-2 col-lg-1">
                                                ...
                                                <input type="number" min="0"
                                                    max="{{ $variant->getStockByLokasiandEntitas($data->werehouse_id, $entitasParam) }}"
                                                    class="form-control qty-input"
                                                    data-stock="{{ $variant->getStockByLokasiandEntitas($data->werehouse_id, $entitasParam) }}"
