...
@section('content')
    <x-page-header title="Satuan List" module="Satuan">
        ...
        <div class="col-6">
            <button type="button" class="btn btn-shadow btn-light-primary me-2 d-flex align-items-center"
                data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><i
                    class="ph-duotone ph-plus-circle icon-search me-2"></i> Add New Satuan</button>
        </div>
    ...
    @php
        $thead = ['No', 'Satuan', 'Last Updated', 'Options'];
    @endphp
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Add New Satuan</h5>
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        $('#form-tambah').on('submit', function(e) {
            e.preventDefault();
            $.ajax({
                url: '{{ route('satuan.simpan') }}', // Route untuk simpan data
                method: 'POST',
                data: $(this).serialize(),
