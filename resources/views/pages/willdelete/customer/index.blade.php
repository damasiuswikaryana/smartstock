...
@section('content')
    <x-page-header title="List Customer" module="Management Customer" >
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 mt-3">
        <div class="col-6">
            <button type="button" class="btn btn-shadow btn-warning me-2 d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><i class="ph-duotone ph-plus-circle icon-search me-2"></i> Tambah Customer Baru</button>
        </div>
    ...
    @php
        $thead = ['No', 'Nama', 'Gender', 'Alamat', 'No. Telepon', 'E-mail', 'Company', 'Jabatan', 'Last Updated', 'Opsi'];
    @endphp
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Tambah Customer Baru</h5>
                ...
                <form class="modal-body" action="#" method="post" id="form-tambah">
                    <div class="px-4">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" placeholder="Nama Customer" name="nama" />
                            </div>
                        </div>
                        <div class="mb-3 row">
    ...
    <script type="text/javascript">
        ...
        let table = $('#myTable').DataTable({
            ...
            columns: [
                ...
                { data: 'nama',             name: 'nama', class: 'text-start' },
                { data: 'jenis_kelamin',    name: 'jenis_kelamin', class: 'text-center' },
                { data: 'alamat',           name: 'alamat', class: 'text-start' },
                { data: 'phone',            name: 'phone', class: 'text-start' },
                { data: 'email',            name: 'email', class: 'text-start' },
                { data: 'company',          name: 'company', class: 'text-start' },
                { data: 'jabatan',          name: 'jabatan', class: 'text-start' },
        ...
        $('#form-tambah').on('submit', function(e) {
            e.preventDefault();
            $.ajax({
              url: '{{ route("customer.simpan") }}', // Route untuk simpan data
              method: 'POST',
              data: $(this).serialize(),
        ...
        $(document).on('click', '.btn-delete', function () {
            let id = $(this).data('id');
            var url = "{{ route('customer.hapus', ':id:') }}";
