...
@section('content')
    <x-page-header title="List Item" module="Management Stock Item" >
        <li class="breadcrumb-item">Management</li>
        <li class="breadcrumb-item">Master Stock Item</li>
    </x-page-header>
    
    <div class="d-flex justify-content-between align-items-center mb-4 mt-3">
        <div class="col-6">
            <button type="button" class="btn btn-shadow btn-warning me-2 d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><i class="ph-duotone ph-plus-circle icon-search me-2"></i> Tambah Item Baru</button>
        </div>
    ...
    @php
        $thead = ['No', 'Kode', 'Nama', 'Last Updated', 'Opsi'];
    @endphp
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Tambah Item Baru</h5>
                ...
                <form class="modal-body" action="#" method="post" id="form-tambah">
                    <div class="px-4">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" placeholder="Kode Item" name="kode" maxlength="3" />
                            </div>
                        </div>
                        <div class="mb-3 row">
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        $('#form-tambah').on('submit', function(e) {
            e.preventDefault();
            $.ajax({
              url: '{{ route("stock-item.simpan") }}', // Route untuk simpan data
              method: 'POST',
              data: $(this).serialize(),
        ...
        $(document).on('click', '.btn-delete', function () {
            let id = $(this).data('id');
            var url = "{{ route('stock-item.hapus', ':id:') }}";
