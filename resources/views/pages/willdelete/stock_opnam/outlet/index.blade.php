...
@section('content')
    <x-page-header title="List Stock Outlet" module="Management Stock {{ $outlet->nama }}" >
        <li class="breadcrumb-item">Stock Opnam</li>
        <li class="breadcrumb-item">Stock Outlet</li>
    </x-page-header>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 mt-3">
        <div class="col-6 d-flex">
            ...
            <a href="{{ route('stock-opnam.outlet.ekspor_stock', $outlet->id) }}" class="btn btn-shadow btn-secondary" data-bs-toggle="tooltip" title="Download ke Excel">
    ...
    <div class="mb-2 mt-5">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <div class="col-6 d-flex">
                ...
                <div class="col-1">
                    <a id="btn-export-mutasi" href="{{ route('stock-opnam.outlet.ekspor_mutasi', ['ido' => $outlet->id, 's' => $awal, 'e' => $akhir]) }}" class="btn btn-shadow btn-secondary" data-bs-toggle="tooltip" title="Download ke Excel">
                        <i class="ph-duotone ph-download-simple icon-search"></i>
                    </a>
                </div>
            </div>
    ...
    <div id="modalKeluarStock" class="modal fade" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="modalKeluarStockTitle">
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form class="modal-body" action="{{ route('stock-opnam.outlet.keluar', $outlet->id) }}" method="post" id="form-keluar">
                    @csrf
                    @method('POST')
                    <div class="px-4">
                        <div class="mb-0 row">
...
@push('js')
    ...
    <script type="text/javascript">
        flatpickr(document.querySelector('#daterange_1'), {
            ...
            onChange: function (selectedDates, dateStr) {
                if (dateStr.includes(" to ")) {
                    ...
                    let baseUrl = "{{ route('stock-opnam.outlet.ekspor_mutasi', ['ido' => ':ido', 's' => 'xxx', 'e' => 'yyy']) }}";
                    baseUrl = baseUrl.replace(':ido', idOutlet).replace('xxx', start).replace('yyy', end);
        ...
        let table = $('#myTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url : "{{ route('stock-opnam.outlet.index', $outlet->id) }}",
                data: { type: 'stock_outlet' }
            },
            scrollY: true,
            scrollX: true,
            scrollCollapse: true,
        ...
        $('#jenis_filter, #daterange_1').on('change', function () {
            table2.ajax.reload();
        });
