...
<div class="modal-header">
    <h5 class="modal-title" id="modalEditTitle">Edit Kegiatan Item</h5>
...
<form class="modal-body" action="#" method="post" id="form-edit">
    <div class="px-4">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-lg-8">
                <input type="text" class="form-control" placeholder="Keterangan" name="keterangan" value="{{ $data->keterangan }}" />
            </div>
        </div>
    </div>
</form>
...
<script>
    $('#form-edit').on('submit', function (e) {
        e.preventDefault();
        const id = "{{ $data->id }}";
        var url = "{{ route('kegiatan-item.update', ':id:') }}";
