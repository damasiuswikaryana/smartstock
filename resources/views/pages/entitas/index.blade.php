...
@section('content')
    <x-page-header title="Entity List" module="Entity Management">
    ...
    @php
        $thead = ['No', 'Entity', 'Address', 'Options'];
    @endphp
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Add New Entity</h5>
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        $('#form-tambah').on('submit', function(e) {
            e.preventDefault();
            $.ajax({
                url: '{{ route('entitas.simpan') }}', // Route untuk simpan data
                method: 'POST',
                data: $(this).serialize(),
        ...
        $(document).on('click', '.btn-delete', function() {
            let id = $(this).data('id');
            var url = "{{ route('entitas.hapus', ':id:') }}";
