<title>Smartstock @yield('title')</title>
<!-- [Meta] -->
<meta charset="utf-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui" />
<meta http-equiv="X-UA-Compatible" content="IE=edge" />
<meta name="description" content="Sistem Pengadaan dan Efisiensi Gudang" />
<meta name="author" content="PT Asta Pijar Kreasi Teknologi" />
<meta name="csrf-token" content="{{ csrf_token() }}">

<!-- [Favicon] icon -->
<link rel="icon" href="{{ asset('assets/images/icons/icon-192x192.jpg') }}" type="image/x-icon" />
...
<!-- [Template CSS Files] -->
<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/style.css') }}?v=4" id="main-style-link">
<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/style-preset.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/custom.css') }}?v=17">
