...
function layout_sidebar_change(value) {
    if (value == "dark") {
        ...
        var darkBtn = document.querySelector(
            ".theme-sidebar-color .btn[data-value='true']",
        );
        if (darkBtn) {
        ...
        var lightBtn = document.querySelector(
            ".theme-sidebar-color .btn[data-value='false']",
        );
        if (lightBtn) {
...
function layout_change(layout) {
    ...
    $.ajax({
            ...
            if (response.success) {
                ...
                if (layout == "dark") {
                    ...
                    if (control) {
                        ...
                        document
                            .querySelector(
                                ".theme-layout .btn[data-value='false']",
                            )
                    ...
                    if (control) {
                        ...
                        document
                            .querySelector(
                                ".theme-layout .btn[data-value='true']",
                            )
                            .classList.add("active");
                    }
                }
        ...
        error: function (xhr) {
            hideLoader();
            showToastError("Gagal:" + xhr.responseText);
        },
    });
}
